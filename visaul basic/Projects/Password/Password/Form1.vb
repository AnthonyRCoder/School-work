Public Class Form1
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        password = 4 'assigns the value 2017 to the variable password
        user_input = InputBox("Please enter class year") 'An inputbox is used to allow the user to enter a numerical password using an inputbox.
        ...
        If user_input = password Then 'the user_input is compared to the password. If the values in the variables are equal the condition is true.
            MsgBox("Correct") 'A msgbox is displayed showing a message.
        End If
        ...
        If user_input <> password Then 'the user_input is compared is to the password. If the  values in the variables are NOT equal then the condition is true.
            MsgBox("Incorrect") 'A msgbox is displayed showing a message
